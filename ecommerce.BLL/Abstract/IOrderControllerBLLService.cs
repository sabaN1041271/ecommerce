...
namespace ecommerce.BLL.Abstract
{
    ...
    {
        Task<PageWrapper<OrderDetailResponseModel>> AllOrders(int page, int perPage, int userId);
        ...
        Task<PageWrapper<OrderDetailResponseModel>> GetOrdersByDate(DateTime dateFrom, DateTime dateTo, int userId);
